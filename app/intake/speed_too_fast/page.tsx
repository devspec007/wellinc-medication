...
export default function SpeedTooFastPage() {
    ...
    return (
        <div className="w-full">
            <div className="title">
                We'll move at
                <span className="title-accent"> your pace</span>.
            </div>
            <div className="title-sm mt-4">
                With GLP-1 medication, your goal to lose {speedDifference}lbs is easier than you think - and it
